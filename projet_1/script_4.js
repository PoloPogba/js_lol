...
console.log("Combien-y-a-t-il de journalistes dans cet array ?");
console.log("Il y en a : "+ MyArray.length);



console.log("Combien d'handle contiennent un numéro ? ")
let count = 0;
for(let i = 0; i < MyArray.length; ++i){
    if(MyArray[i].replace(/[^0-9]/g,""))
        count++;
}
console.log("Il y a : " + count+ " handles avec des numéros parmi tous ces handles ! ");
...
let nb = 0
for(let i = 0; i < MyArray.length; ++i){
  if (MyArray[i].toLowerCase().includes(substring))
  nb++;
}
console.log("Il y a "+nb+" handles qui contiennent ces lettres");
...
let nombre = 0;
for(let i = 0; i < MyArray.length; ++i){
    if(MyArray[i].match(/@[A-Z]/))
    nombre++;
}
console.log("Nous pouvons en dénombrer "+nombre+" !")
...
console.log(lol+ " handles contiennent des majuscules!")
